...
const ENTITIES: EntityDef[] = [
  ...
  { key: 'ig_media', label: 'Instagram — Posts',
    description: 'Lista de mídias · header + likes/comments',
    pending: true, pendingReason: 'Requer permissão `instagram_basic` (App Review)' },
  ...
  { key: 'fb_posts', label: 'Facebook — Posts',
    ...
    pending: true, pendingReason: 'Requer permissão `pages_read_engagement`' },
  { key: 'pixel', label: 'Pixel',
    description: 'Detalhes + último disparo' },
]
