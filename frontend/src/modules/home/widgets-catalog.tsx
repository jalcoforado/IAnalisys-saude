...
import { EvolucaoFaturamentoCard } from './widgets/EvolucaoFaturamentoCard'
import { FunilOrcamentosCard } from './widgets/FunilOrcamentosCard'
import { EvolucaoConsultasCard } from './widgets/EvolucaoConsultasCard'
import { TopProcedimentosCard } from './widgets/TopProcedimentosCard'
import { SaudeBaseCard } from './widgets/SaudeBaseCard'
...
export const WIDGET_CATALOG: WidgetMeta[] = [
  ...
  {
    id: 'saldo_por_banco',
    name: 'Distribuição por banco',
    description: 'Grid de contas bancárias com saldo, caixinhas e contas inativas.',
    category: 'Financeiro',
    permission: 'financeiro.read',
    defaultSize: { w: 6, h: 5 },
    minSize: { w: 4, h: 4 },
    icon: Landmark,
    render: () => <SaldoPorBancoCard />,
  },

  // ── Análise — gráficos e funis ─────────────────────────────
  {
    id: 'evolucao_faturamento',
    name: 'Evolução 12m — Faturamento',
    description: 'Faturamento mensal vs Recebido nos últimos 12 meses.',
    category: 'Comercial',
    permission: 'dashboard.read',
    defaultSize: { w: 6, h: 5 },
    minSize: { w: 4, h: 4 },
    icon: BarChart,
    render: () => <EvolucaoFaturamentoCard />,
  },
  {
    id: 'funil_orcamentos',
    name: 'Funil de orçamentos',
    description: 'Gerados → Aprovados → Pagos com taxas de conversão.',
    category: 'Comercial',
    permission: 'dashboard.read',
    defaultSize: { w: 4, h: 5 },
    minSize: { w: 3, h: 4 },
    icon: Filter,
    render: () => <FunilOrcamentosCard />,
  },
  {
    id: 'evolucao_consultas',
    name: 'Evolução 12m — Agenda',
    description: 'Consultas efetivas, faltas, canceladas e sem status (12m).',
    category: 'Agenda',
    permission: 'dashboard.read',
    defaultSize: { w: 6, h: 5 },
    minSize: { w: 4, h: 4 },
    icon: BarChart,
    render: () => <EvolucaoConsultasCard />,
  },
  {
    id: 'top_procedimentos',
    name: 'Top procedimentos executados',
    description: 'Pareto dos procedimentos por volume com faturamento e ticket.',
    category: 'Comercial',
    permission: 'dashboard.read',
    defaultSize: { w: 4, h: 6 },
    minSize: { w: 3, h: 4 },
  ...
  // ── Pacientes — visão estratégica ──────────────────────────
  {
    id: 'saude_base',
    name: 'Saúde da base',
    description: 'Distribuição da base por bucket (ativo/em risco/inativo/perdido).',
    category: 'Pacientes',
    permission: 'pacientes.read',
    defaultSize: { w: 6, h: 4 },
    minSize: { w: 4, h: 3 },
    icon: Activity,
    render: () => <SaudeBaseCard />,
  },
  {
    id: 'top_ltv',
    name: 'Top LTV — pacientes mais valiosos',
    description: 'Ranking dos pacientes por LTV com bucket de status.',
    category: 'Pacientes',
    permission: 'pacientes.read',
    defaultSize: { w: 4, h: 6 },
    minSize: { w: 3, h: 4 },
  ...
  },
  {
    id: 'para_resgatar',
    name: 'Para Resgatar',
    description: 'Pacientes em risco/inativos com LTV alto — ação imediata.',
    category: 'Pacientes',
    permission: 'pacientes.read',
    defaultSize: { w: 8, h: 5 },
    minSize: { w: 5, h: 4 },
